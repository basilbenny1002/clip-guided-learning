...
#Load teh clip model
# CHANGED: Switched from B/32 to RN50
...
# CHANGED: Updated filename to include RN50
out_pil.save("results/unconstrained result RN50.png")

print("Calculating similarity of the unconstrained image")
# CHANGED: Updated filename here to match
verify_img = preprocess(Image.open("results/unconstrained result RN50.png")).unsqueeze(0).to(DEVICE)
