...
out_pil.save("results/unconstrained result ViT-L-14.png")

print("Calculating similarity of the unconstrained image")
verify_img = preprocess(Image.open("results/unconstrained result ViT-L-14.png")).unsqueeze(0).to(DEVICE)
